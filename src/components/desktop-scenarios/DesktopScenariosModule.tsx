...
export function DesktopScenariosModule() {
  ...
  if (screen === "intro" && activeScenario) {
    return <MobileScenarioIntro scenario={activeScenario} onBack={reset} onStart={startScenario} />;
  }

  return <DesktopScenariosList scenarios={SCENARIO_MODULES} onOpen={openIntro} />;
}
