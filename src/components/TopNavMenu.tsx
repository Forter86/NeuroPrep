...
const ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    label: "Тесты",
    description:
      "Проверка знаний по охране труда: адаптивные тесты с вопросами по газоопасным работам, СИЗ и работам на высоте.",
  },
  {
    id: "scenarios",
    label: "Сценарии",
    description:
      "Отработка действий в реальных ситуациях: пошаговые сценарии с мгновенной обратной связью.",
  },
  {
    id: "analytics",
